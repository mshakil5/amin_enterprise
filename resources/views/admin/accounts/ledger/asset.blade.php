                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <div class="info-box bg-info">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Total Debit (Added)</span>
                            ...
                            <div class="col-md-4">
                                <div class="info-box bg-danger">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Total Credit (Reduced)</span>
                            ...
                            <div class="col-md-4">
                                <div class="info-box bg-success">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Asset Value (Balance)</span>
                            ...
                            <table id="ledgerTable" class="table table-striped table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    @forelse($data as $transaction)
                                        @php
                                            $isDebit = in_array($transaction->tran_type, ['Purchase', 'Payment']);
                                            $isCredit = in_array($transaction->tran_type, ['Sold', 'Deprication']);
                                            ...
                                            // Reverse the effect for next row (going backwards)
                                            // Asset Debit increased value, so going back: subtract it
                                            // Asset Credit decreased value, so going back: add it back
                                            $runningBalance = $runningBalance - $debitAmount + $creditAmount;
                                        @endphp
                                        
                                        <tr>
                                            <td class="text-center">{{ $transaction->tran_id }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @elseif($isCredit)
                                                    <span class="badge badge-danger">{{ $transaction->tran_type }}</span>
                                                @else
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center text-muted py-4">
                                                ...
                                                No asset transactions found for this period.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                                ...
                                <tfoot>
                                    <tr class="font-weight-bold bg-light">
                                        ...
                                        <td class="text-right text-danger">{{ number_format($totalCrAmount, 2) }}</td>
                                        <td class="text-right">
