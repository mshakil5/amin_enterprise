                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <div class="info-box bg-info">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Total Debit (Drawings)</span>
                            ...
                            <div class="col-md-4">
                                <div class="info-box bg-success">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Total Credit (Invested)</span>
                                ...
                                <tbody>
                                    ...
                                    @forelse($data as $transaction)
                                        @php
                                            ...
                                            // Debit (Payment) decreased equity, so going back: add it
                                            // Credit (Received) increased equity, so going back: subtract it
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center text-muted py-4">
                                                ...
                                                No equity transactions found for this period.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
...
<script>
    $(function () {
        $("#ledgerTable").DataTable({
            ...
            language: {
                search: "",
                searchPlaceholder: "Search equity..."
            }
        });
    });
</script>
