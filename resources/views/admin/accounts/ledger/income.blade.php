                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <div class="info-box bg-danger">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Total Refund (Debit)</span>
                            ...
                            <div class="col-md-4">
                                <div class="info-box bg-success">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Total Income (Credit)</span>
                                ...
                                <tbody>
                                    ...
                                    @forelse($data as $transaction)
                                        @php
                                            ...
                                            // Income Credit increased balance, so going back: subtract it
                                            // Refund Debit decreased balance, so going back: add it back
